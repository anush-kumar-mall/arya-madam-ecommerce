...
Please confirm my order and share delivery details.
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-[#f8f4ed] to-white px-6 py-20">
      <div className="max-w-4xl mx-auto">
        
        {/* Header */}
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-[rgb(44_95_124)] mb-3">
            Your Cart
          </h1>
        ...
        {cartItems.length === 0 ? (
          ...
          <div className="text-center py-20">
            ...
            <a
              href="/shop"
              className="inline-block px-8 py-3 bg-[rgb(44_95_124)] text-white rounded-full
              hover:bg-[rgb(34_75_104)] transition font-medium"
            >
              Continue Shopping
            </a>
          </div>
          ...
          <div className="space-y-6">
                ...
                >
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <p className="text-[rgb(44_95_124)] font-bold text-xl">
                        ₹{item.price}
                      </p>
                    </div>
                    ...
                    <div className="flex items-center gap-4 mt-3">
                      <div className="flex items-center gap-3 border border-gray-200 rounded-lg px-3 py-2">
                        <button
                          ...
                          className="text-gray-600 hover:text-[rgb(44_95_124)] font-bold text-xl w-6 h-6 flex items-center justify-center"
                        >
                          −
                        </button>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <button
                ...
                className="w-full py-4 bg-[#25D366] text-white rounded-full font-semibold text-lg
